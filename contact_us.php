...
<p class="p2">Silver Oak University</p>

<p class="p3">Address: SILVEROAK CAMPUS AND RESEARCH FOUNDATION
352/353,370/371,
 GOTA GAM, AHMEDABAD, Ahmedabad,
  Gujarat, India, 382481.<br>
Gujrat<br><br></p>

<table>
  
<tr>
<TD><BR><img src="image/MAP.PNG" alt="MAP Image" class="left-image" ></TD>
	<td>
			<p class="p2">Contact us at:</p>
			<p class="p3">+91-79-35201300</p>
	</td>		
	<td >
  <p class="p2">Email:</p> info@silveroakuni.ac.in
<p class="p3"></p></td><br /><br />
    <p class="p2">Our Social Pages:</p>
  <p class="p3"> <a href="">
   <img src="pictures/facebook.png" width="40" height="40"></a> 
   <a href="https://www.instagram.com/duias.valsad/"> 
...
<p class="p3">All individuals who have followed Diploma, Undergraduate, Postgraduate or PhD can register as our alumni.</p>
<p class="p2"><br>How do I become a member of the SOU Alumni?</p>
<p class="p3">All undergraduates and post graduates of SOU can register as
 our alumni. It is important for alumni to update their particulars for the SOU Alumni
